...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20201220200052230_jlm_BACH",
							"iterations" : 0,
...
,
						"initialConditions" : 						{
							...
							"genotypeSeed" : "8587005958332219",
							"phenotypeSeed" : "45549027046767"
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.606798, 1, 0.27051, 0.51, 0.7, 0, 1, 0.506578, 0.53, 0.58, 0.53, 0.57, 0.53, 0.6, 0.53, 0.59, 0, 1, 0.742646, 0.55, 0.612091, 0, 1, 0.36068, 0.56, 0.8, 0, 0, 0 ],
						"decodedGenotype" : "s(vMotifLoop(ln(0.5),lm(70,69,72,71),la(79),li(80)))",
						"formattedGenotype" : "s(\n   vMotifLoop(\n      ln(\n         0.5),\n      lm(\n         70,\n         69,\n         72,\n         71),\n      la(\n         79),\n      li(\n         80)))",
						"encodedPhenotype" : [ 0.618034, 0.472136, 0.7, 0.618034, 0.58, 0.612091, 0.8, 0.7, 0.618034, 0.57, 0.612091, 0.8, 0.7, 0.618034, 0.6, 0.612091, 0.8, 0.7, 0.618034, 0.59, 0.612091, 0.8 ],
						"subexpressions" : 						{
							"paramF" : [  ],
							"listF" : [  ],
							"eventF" : [  ],
							"voiceF" : [ "vMotifLoop(ln(0.5),lm(70,69,72,71),la(79),li(80))" ],
							"scoreF" : [ "s(vMotifLoop(ln(0.5),lm(70,69,72,71),la(79),li(80)))" ],
							"notevalueF" : [  ],
							"lnotevalueF" : [ "ln(0.5)" ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [  ],
							"lmidipitchF" : [ "lm(70,69,72,71)" ],
							"frequencyF" : [  ],
							"lfrequencyF" : [  ],
							"articulationF" : [  ],
							"larticulationF" : [ "la(79)" ],
							"intensityF" : [  ],
							"lintensityF" : [ "li(80)" ],
							"goldenintegerF" : [  ],
							"lgoldenintegerF" : [  ],
...
,
						"leaves" : [ [ 7, 0.7, 0.5 ], [ 12, 0.58, 70 ], [ 14, 0.57, 69 ], [ 16, 0.6, 72 ], [ 18, 0.59, 71 ], [ 23, 0.612091, 78 ], [ 28, 0.8, 80 ] ],
						"roll" : [ "(", "(", 0, "(", 7000, 1560, 107, ")", ")", "(", 2000, "(", 6900, 1560, 107, ")", ")", "(", 4000, "(", 7200, 1560, 107, ")", ")", "(", 6000, "(", 7100, 1560, 107, ")", ")", ")" ]
					}
,
					"fontname" : "Lato Regular",
					"id" : "obj-111",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 527.0, 27.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ -0.5, -2.0, 637.0, 27.0 ],
									"text" : "0.618034 0.472136 0.7 0.618034 0.58 0.612091 0.8 0.7 0.618034 0.57 0.612091 0.8 0.7 0.618034 0.6 0.612091 0.8 0.7 0.618034 0.59 0.612091 0.8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 0.0, 2.5, 165.0, 45.0 ],
									"presentation" : 1,
									"presentation_linecount" : 4,
									"presentation_rect" : [ 0.0, -0.5, 165.0, 45.0 ],
									"text" : "roll ( ( 0 ( 7000 1560 107 ) ) ( 2000 ( 6900 1560 107 ) ) ( 4000 ( 7200 1560 107 ) ) ( 6000 ( 7100 1560 107 ) ) )",
