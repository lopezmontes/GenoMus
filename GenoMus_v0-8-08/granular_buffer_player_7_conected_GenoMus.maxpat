...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1480.0, 836.735846161842346, 114.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 634.0, 259.0, 127.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 498.0, 259.0, 127.0, 22.0 ],
									"text" : "receive~ fromReverbL"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 372.0, 332.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 372.0, 297.5, 35.0, 22.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 295.0, 350.0, 69.0, 22.0 ],
									"text" : "sfrecord~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 35.0, 288.0, 41.0, 41.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 157.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 89.0, 288.0, 55.0, 22.0 ],
									"text" : "dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 352.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 340.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 304.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 292.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 252.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 240.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 204.0, 105.0, 12.0, 136.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 192.0, 105.0, 12.0, 136.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 1215.0, 61.0, 50.0, 22.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "", "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 1271.0, 61.0, 50.0, 22.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 19.0, 14.0, 328.0, 116.0 ],
...
,
									"patching_rect" : [ 265.0, 27.0, 91.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 593.0, 75.0, 17.0 ],
					"text" : "r soundsSelected1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 142.0, 489.5, 27.0, 17.0 ],
					"text" : "r kB2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.5, 465.0, 27.0, 17.0 ],
					"text" : "r kB1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 405.20547616481781, 32.0, 17.0 ],
					"text" : "r bkA1"
				}
...
,
					"patching_rect" : [ 1292.0, 688.0, 117.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 969.0, 35.0, 50.0, 22.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 53.5, 185.5, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 43.0, 217.5, 29.5, 22.0 ],
									"text" : "+ 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 81.25, 217.5, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 63.75, 244.0, 29.5, 22.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 85.75, 276.0, 41.0, 32.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 125.75, 56.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 301.75, 164.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 66.75, 64.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 63.75, 109.0, 63.0, 22.0 ],
									"text" : "metro 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 219.75, 196.0, 101.0, 22.0 ],
									"text" : "expr pow($f2\\,$i1)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 63.75, 139.0, 59.0, 22.0 ],
									"text" : "random 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 61.25, 330.0, 29.5, 22.0 ],
									"text" : "* 1."
								}
...
,
					"patching_rect" : [ 1188.0, 362.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 8.0, 45.0, 22.0 ],
					"text" : "r pedal"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.342463910579681, 319.862990438938141, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1243.0, 43.0, 100.0, 40.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-9", "flonum", "float", 92.0, 5, "obj-80", "number", "int", 0, 5, "obj-2", "flonum", "float", 0.189999997615814, 5, "obj-22", "flonum", "float", 1.0, 6, "obj-6", "number~", "list", 0.0, 0.0, 5, "obj-10", "flonum", "float", 1.0, 5, "obj-11", "flonum", "float", 0.0, 5, "obj-14", "flonum", "float", 0.0, 5, "obj-18", "number", "int", 14, 6, "obj-30", "gain~", "list", 128, 10.0, 6, "<invalid>", "gain~", "list", 101, 10.0, 5, "obj-27", "flonum", "float", 2313.0, 5, "obj-19", "toggle", "int", 1, 5, "obj-99", "number", "int", 302, 6, "obj-96", "number~", "list", 0.0, 0.0, 5, "obj-91", "number", "int", 300, 5, "obj-89", "number", "int", 0, 5, "obj-87", "flonum", "float", 0.0, 5, "obj-119", "number", "int", 0, 6, "obj-117", "number~", "list", 0.0, 0.0, 5, "obj-115", "number", "int", 0, 5, "obj-113", "number", "int", 0, 5, "obj-112", "flonum", "float", 0.0, 5, "obj-136", "number", "int", 0, 5, "obj-46", "toggle", "int", 0, 5, "obj-60", "gswitch2", "int", 0, 5, "obj-61", "gswitch2", "int", 0, 5, "obj-68", "flonum", "float", 0.0, 5, "obj-145", "slider", "float", 37.0, 5, "obj-148", "slider", "float", 0.0, 5, "<invalid>", "toggle", "int", 0, 5, "<invalid>", "flonum", "float", 0.0, 5, "<invalid>", "number", "int", 0, 5, "<invalid>", "gswitch", "int", 0, 5, "<invalid>", "flonum", "float", 0.0, 5, "<invalid>", "flonum", "float", 0.0, 5, "obj-138", "number", "int", 11448, 5, "obj-142", "slider", "float", 0.0, 5, "obj-158", "slider", "float", 0.0, 5, "obj-160", "umenu", "int", 19, 5, "obj-165", "number", "int", 19, 5, "obj-173", "number", "int", 11448, 5, "obj-168", "gswitch2", "int", 0, 5, "<invalid>", "gswitch2", "int", 0, 5, "<invalid>", "toggle", "int", 0, 5, "obj-206", "number", "int", 0, 5, "obj-209", "number", "int", 0, 5, "<invalid>", "number", "int", 0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-9", "flonum", "float", 36.0, 5, "obj-80", "number", "int", 0, 5, "obj-2", "flonum", "float", 0.189999997615814, 5, "obj-22", "flonum", "float", 1.0, 6, "obj-6", "number~", "list", 0.0, 0.0, 5, "obj-10", "flonum", "float", 1.0, 5, "obj-11", "flonum", "float", 0.0, 5, "obj-14", "flonum", "float", 0.0, 5, "obj-18", "number", "int", 14, 6, "obj-30", "gain~", "list", 128, 10.0, 6, "<invalid>", "gain~", "list", 101, 10.0, 5, "obj-27", "flonum", "float", 2313.0, 5, "obj-19", "toggle", "int", 1, 5, "obj-99", "number", "int", 302, 6, "obj-96", "number~", "list", 0.0, 0.0, 5, "obj-91", "number", "int", 300, 5, "obj-89", "number", "int", 0, 5, "obj-87", "flonum", "float", 0.0, 5, "obj-119", "number", "int", 0, 6, "obj-117", "number~", "list", 0.0, 0.0, 5, "obj-115", "number", "int", 0, 5, "obj-113", "number", "int", 0, 5, "obj-112", "flonum", "float", 0.0, 5, "obj-136", "number", "int", 0, 5, "obj-46", "toggle", "int", 1, 5, "obj-60", "gswitch2", "int", 1, 5, "obj-61", "gswitch2", "int", 1, 5, "obj-68", "flonum", "float", 0.0, 5, "obj-145", "slider", "float", 37.0, 5, "obj-148", "slider", "float", 0.0, 5, "<invalid>", "toggle", "int", 0, 5, "<invalid>", "flonum", "float", 0.0, 5, "<invalid>", "number", "int", 0, 5, "<invalid>", "gswitch", "int", 0, 5, "<invalid>", "flonum", "float", 0.0, 5, "<invalid>", "flonum", "float", 0.0, 5, "obj-138", "number", "int", 11448, 5, "obj-142", "slider", "float", 0.0, 5, "obj-158", "slider", "float", 0.0, 5, "obj-160", "umenu", "int", 19, 5, "obj-165", "number", "int", 19, 5, "obj-173", "number", "int", 11448, 5, "obj-168", "gswitch2", "int", 0, 5, "<invalid>", "gswitch2", "int", 0, 5, "<invalid>", "toggle", "int", 0, 5, "obj-206", "number", "int", 0, 5, "obj-209", "number", "int", 0, 5, "<invalid>", "number", "int", 0 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1195.941178888082504, 840.824080646038055, 33.529406905174255, 20.0 ],
					"text" : "dry",
					"textcolor" : [ 0.811764705882353, 0.811764705882353, 0.811764705882353, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.5, 543.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 25.0, 566.0, 29.5, 22.0 ],
					"text" : "+ 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 61.5, 486.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 437.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 25.0, 519.0, 66.0, 22.0 ],
					"text" : "random 20"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 486.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.5, 699.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.5, 667.0, 227.0, 22.0 ],
					"text" : "jstrigger (parseInt(a[0].substring(0\\,7)\\,10))"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 142.0, 619.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.25, 619.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					"fontname" : "Courier",
					"id" : "obj-160",
					"items" : [ "0177489p07900i23a57d94n10s21h93m33_lepolainyann_stones.wav", ",", "0031399p07100i62a87d10n10s81h91m87_felix_blume_stones_falling_into_a_mine_hole_in_real_de_catorce_mexico.wav", ",", "0048923p05300i32a65d99n00s94h92m32_josedu_rocks_hits.wav", ",", "0030668p09725i32a11d92n07s87h76m07_department64_singing_stone.wav", ",", "0015172p06200i40a99d99n00s92h60m26_ra_gun_rock_various_hits.wav", ",", "0001950p08000i36a75d95n39s60h33m75_victor_gravit_waves_003.wav", ",", "0006153p06700i78a99d84n10s33h35m94_qubodup_gathering_stone_resources.wav", ",", "0001263p06100i39a61d93n00s81h33m44_mbezzola_stein_aufschlag_mit_langem_decay_04.wav", ",", "0003642p06200i16a98d81n00s42h32m13_unclesigmund_stone_tap.wav", ",", "0000797p05990i05a25d95n56s58h27m72_victor_gravit_waves_002.wav", ",", "0000399p06100i89a96d96n00s27h28m30_alegemaate_stone_dropping.wav", ",", "0000977p05600i11a31d89n00s31h27m07_14fpanska_nemec_petr_37_2_water_drop_stone.wav", ",", "0002174p05500i82a88d93n36s56h21m62_victor_gravit_waves_004.wav", ",", "0001407p06720i28a37d95n56s33h16m67_victor_gravit_waves_001.wav", ",", "0004201p07000i72a68d86n00s60h19m14_kessir_horn_dropped_on_stone_floor_2.wav", ",", "0000593p06700i65a84d96n28s53h14m75_victor_gravit_waves_005.wav", ",", "0009804p08500i07a48d92n00s03h16m27_davidsonfreemedia_walking_on_stones.wav", ",", "0002164p06700i66a97d98n10s10h14m47_soundcollectah_stone_falls_and_breaks_low_pitch.wav", ",", "0003528p08470i17a88d93n81s12h10m30_quickgorgoteo.wav", ",", "0011938p05000i91a30d22n10s08h14m92_uagadugu_cracking_earthquake_cracking_soil_cracking_stone.wav", ",", "0033000p04400i46a81d95n00s24h14m53_sheyvan_steps_sneakers_on_stone.wav", ",", "0000555p05580i17a71d96n33s42h10m49_victor_gravit_waves_006.wav", ",", "0002293p05000i37a88d96n32s39h09m68_victor_gravit_waves_008.wav", ",", "0000789p05000i66a84d96n28s35h09m74_victor_gravit_waves_007.wav", ",", "0002982p08900i19a96d79n00s75h10m06_kastenfrosch_stone_crumble.wav", ",", "0002612p10400i29a31d95n00s14h09m24_falcospizaetus_rockslide02.wav", ",", "0002160p06600i30a60d96n00s16h09m85_dslrguide_scraping_stone.wav", ",", "0002490p06300i11a36d97n00s35h07m37_higorfariass_pedregulhos.wav", ",", "0007770p06800i10a19d95n00s54h07m20_usuarioleal_07_moneda_piedra.wav", ",", "0005640p10400i33a82d94n00s42h07m03_meggiepie_tiny_hammer_on_stone.wav", ",", "0009460p06200i11a24d93n06s04h06m24_unclesigmund_stone_tap_2.wav", ",", "0008171p07400i42a86d90n00s17h06m17_launemax_kicking_a_stone.wav", ",", "0013565p06773i28a99d94n00s74h06m18ra_gun_rock_various_hits_2.wav", ",", "0004899p02000i21a15d91n00s16h06m90_breviceps_opening_the_sarcophagus.wav", ",", "0007882p05100i40a31d94n00s35h05m69_wilhelmsqueek_stone_on_stone_st.wav", ",", "0042153p06800i23a45d93n00s95h04m10_samuelgremaud_stone.wav", ",", "0286366p09630i18a79d91n00s54h03m00_reconsider59_various_glassy_stone_windchime_sounds.wav", ",", "0062015p08380i30a77d85n00s38h03m88_rooms_boxes_stone_sliding.wav", ",", "0000309p02700i94a99d99n00s12h01m50_camomano_stone_hit.wav", ",", "0003106p02200i42a17d71n00s33h01m57_d00121058_fx_023_rotatingstone.wav", ",", "0000158p04400i81a98d99n00s07h00m56350343_nettimato_tap_stone.wav", ",", "0007100p04900i46a84d94n00s14h00m87_kinoton_tomb_door_open_stone_scrape.wav" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.25, 643.0, 689.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 643.25, 71.0, 119.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1096.0, 88.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1133.0, 88.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.25, 593.0, 88.0, 22.0 ],
					"text" : "nw.cppan~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.0, 266.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 347.25, 165.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 403.5, 159.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 403.5, 198.0, 29.5, 22.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 236.0, 34.0, 22.0 ],
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 347.25, 198.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 266.0, 52.0, 22.0 ],
					"text" : "0, $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 381.0, 294.0, 40.0, 22.0 ],
					"text" : "line"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 229.0, 150.0, 20.0 ],
					"text" : "onset time (ms)",
					"textcolor" : [ 0.811764705882353, 0.811764705882353, 0.811764705882353, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 255.0, 150.0, 20.0 ],
					"text" : "deviation (ms)",
					"textcolor" : [ 0.811764705882353, 0.811764705882353, 0.811764705882353, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1330.0, 159.0, 54.0, 20.0 ],
					"text" : "GAIN",
					"textcolor" : [ 0.811764705882353, 0.811764705882353, 0.811764705882353, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1201.411764681339264, 744.735846161842346, 22.588235318660736, 98.588234484195709 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1037.397057890892029, 821.382896959781647, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 994.397057890892029, 821.382896959781647, 29.5, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 994.397057890892029, 845.382896959781647, 62.498230516910553, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1332.0, 186.5, 50.0, 22.0 ],
					"textcolor" : [ 0.811764705882353, 0.811764705882353, 0.811764705882353, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 939.248230516910553, 749.441172420978546, 1003.897057890892029, 749.441172420978546 ],
					"order" : 0,
					"source" : [ "obj-88", 0 ]
				}
