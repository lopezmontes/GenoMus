...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20201221113857772_not_found",
...
,
						"initialConditions" : 						{
							...
							"maxAllowedDepth" : 16,
							"germinalVector" : [ 0.997293, 0.792822, 0.269763, 0.011144, 0.110457, 0.247681, 0.907865, 0.977452, 0.593728, 0.943779, 0.49505, 0.586007, 0.736691, 0.864832, 0.197741, 0.927229, 0.8303, 0.441531, 0.948628, 0.13157, 0.301675, 0.282516, 0.007569, 0.3637, 0.276468, 0.661159, 0.557936, 0.690032, 0.770829, 0.145708, 0.268585, 0.090493, 0.358361, 0.291656, 0.654828, 0.463546, 0.469015, 0.076192, 0.636543, 0.861934, 0.141205, 0.908029, 0.539784, 0.905906, 0.858324, 0.257792, 0.16973, 0.859376, 0.655469, 0.919527, 0.583283, 0.953727, 0.881859, 0.354247, 0.899637, 0.516984, 0.700688, 0.975412, 0.36387 ],
							"genotypeSeed" : "9216838858417364",
							"phenotypeSeed" : "84058148501463"
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.854102, 1, 0.236068, 1, 0, 0.5, 0, 0, 1, 0, 0.5, 0, 0, 1, 0, 0.5, 0, 0, 1, 0, 0.5, 0, 0, 0, 0, 0 ],
						"decodedGenotype" : "s(v(e(p(0),p(0),p(0),p(0))))",
						"formattedGenotype" : "s(\n   v(\n      e(\n         p(0),\n         p(0),\n         p(0),\n         p(0))))",
						"encodedPhenotype" : [ 0.618034, 0.618034, 0, 0.618034, 0, 0, 0 ],
						"subexpressions" : 						{
							"paramF" : [ "p(0)", "pAutoref(0)" ],
							"listF" : [  ],
							"eventF" : [ "e(p(0),m(43),p(0),p(0))", "e4Pitches(nRnd(),mAutoref(0),mRnd(),mRnd(),m(53),a(25),i(0))", "e3Pitches(n(0.026874),mAutoref(2),mAutoref(0),mAutoref(4),aRnd(),iRnd())", "e3Pitches(nAutoref(2),m(40),mAutoref(0),mAutoref(1),aAutoref(0),iRnd())", "e4Pitches(n(0.420541),mAutoref(4),mRnd(),mRnd(),mRnd(),aRnd(),i(72))", "eAutoref(1)", "eAutoref(4)", "e(p(0),p(0),p(0),p(0))" ],
							"voiceF" : [ "v(e(p(0),m(43),p(0),p(0)))", "vConcatE(e4Pitches(nRnd(),mAutoref(0),mRnd(),mRnd(),m(53),a(25),i(0)),e3Pitches(n(0.026874),mAutoref(2),mAutoref(0),mAutoref(4),aRnd(),iRnd()))", "vPerpetuumMobileLoop(nAutoref(0),lm(43),laLine(aRnd(),aRnd(),z(24)),liRemap(liLine(iRnd(),iRnd(),z(19)),iRnd(),i(45)))", "vConcatE(e3Pitches(nAutoref(2),m(40),mAutoref(0),mAutoref(1),aAutoref(0),iRnd()),e4Pitches(n(0.420541),mAutoref(4),mRnd(),mRnd(),mRnd(),aRnd(),i(72)))", "vMotifLoop(lnRemap(ln(0.363098,0.106656,0.85244,0.035321),n(0.006717),nAutoref(5)),lmLine(mRnd(),m(56),z(38)),laAutoref(0),liRemap(li(52,72,67,40,35),iRnd(),iAutoref(2)))", "vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laAutoref(0),li(85,54,77,50,53,60))", "vPerpetuumMobileLoop(n(0.363098),lmAutoref(1),laAutoref(2),liAutoref(1))", "vConcatV(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laAutoref(0),li(85,54,77,50,53,60)),vPerpetuumMobileLoop(n(0.363098),lmAutoref(1),laAutoref(2),liAutoref(1)))", "vMotif(lnRemap(ln(0.026874,0.084359,0.068707,0.192584,0.113254,0.114948,0.023837,0.182483,0.426484),n(0.139219),nRnd()),lm(68,85,65,91,81,56),laRemap(laLine(aRnd(),aRnd(),z(23)),aRnd(),aRnd()),liLine(iRnd(),iRnd(),z(16)))", "v(eAutoref(1))", "vABAv(vMotif(lnRemap(ln(0.026874,0.084359,0.068707,0.192584,0.113254,0.114948,0.023837,0.182483,0.426484),n(0.139219),nRnd()),lm(68,85,65,91,81,56),laRemap(laLine(aRnd(),aRnd(),z(23)),aRnd(),aRnd()),liLine(iRnd(),iRnd(),z(16))),v(eAutoref(1)))", "vABCABv(vMotifLoop(lnRemap(ln(0.363098,0.106656,0.85244,0.035321),n(0.006717),nAutoref(5)),lmLine(mRnd(),m(56),z(38)),laAutoref(0),liRemap(li(52,72,67,40,35),iRnd(),iAutoref(2))),vConcatV(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laAutoref(0),li(85,54,77,50,53,60)),vPerpetuumMobileLoop(n(0.363098),lmAutoref(1),laAutoref(2),liAutoref(1))),vABAv(vMotif(lnRemap(ln(0.026874,0.084359,0.068707,0.192584,0.113254,0.114948,0.023837,0.182483,0.426484),n(0.139219),nRnd()),lm(68,85,65,91,81,56),laRemap(laLine(aRnd(),aRnd(),z(23)),aRnd(),aRnd()),liLine(iRnd(),iRnd(),z(16))),v(eAutoref(1))))", "vSlice(v(e(p(0),m(43),p(0),p(0))),q(-7))", "vRepeatE(eAutoref(4),pAutoref(0))", "vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3))", "v(e(p(0),p(0),p(0),p(0)))" ],
							"scoreF" : [ "s(v(e(p(0),m(43),p(0),p(0))))", "sAddV(s(v(e(p(0),m(43),p(0),p(0)))),vConcatE(e4Pitches(nRnd(),mAutoref(0),mRnd(),mRnd(),m(53),a(25),i(0)),e3Pitches(n(0.026874),mAutoref(2),mAutoref(0),mAutoref(4),aRnd(),iRnd())))", "s2V(vPerpetuumMobileLoop(nAutoref(0),lm(43),laLine(aRnd(),aRnd(),z(24)),liRemap(liLine(iRnd(),iRnd(),z(19)),iRnd(),i(45))),vConcatE(e3Pitches(nAutoref(2),m(40),mAutoref(0),mAutoref(1),aAutoref(0),iRnd()),e4Pitches(n(0.420541),mAutoref(4),mRnd(),mRnd(),mRnd(),aRnd(),i(72))))", "s2V(vSlice(v(e(p(0),m(43),p(0),p(0))),q(-7)),vRepeatE(eAutoref(4),pAutoref(0)))", "s(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3)))", "sAutoref(3)", "sAddS(s(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3))),sAutoref(3))", "sAddS(s2V(vSlice(v(e(p(0),m(43),p(0),p(0))),q(-7)),vRepeatE(eAutoref(4),pAutoref(0))),sAddS(s(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3))),sAutoref(3)))", "sAddS(s2V(vPerpetuumMobileLoop(nAutoref(0),lm(43),laLine(aRnd(),aRnd(),z(24)),liRemap(liLine(iRnd(),iRnd(),z(19)),iRnd(),i(45))),vConcatE(e3Pitches(nAutoref(2),m(40),mAutoref(0),mAutoref(1),aAutoref(0),iRnd()),e4Pitches(n(0.420541),mAutoref(4),mRnd(),mRnd(),mRnd(),aRnd(),i(72)))),sAddS(s2V(vSlice(v(e(p(0),m(43),p(0),p(0))),q(-7)),vRepeatE(eAutoref(4),pAutoref(0))),sAddS(s(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3))),sAutoref(3))))", "sAddS(sAddV(s(v(e(p(0),m(43),p(0),p(0)))),vConcatE(e4Pitches(nRnd(),mAutoref(0),mRnd(),mRnd(),m(53),a(25),i(0)),e3Pitches(n(0.026874),mAutoref(2),mAutoref(0),mAutoref(4),aRnd(),iRnd()))),sAddS(s2V(vPerpetuumMobileLoop(nAutoref(0),lm(43),laLine(aRnd(),aRnd(),z(24)),liRemap(liLine(iRnd(),iRnd(),z(19)),iRnd(),i(45))),vConcatE(e3Pitches(nAutoref(2),m(40),mAutoref(0),mAutoref(1),aAutoref(0),iRnd()),e4Pitches(n(0.420541),mAutoref(4),mRnd(),mRnd(),mRnd(),aRnd(),i(72)))),sAddS(s2V(vSlice(v(e(p(0),m(43),p(0),p(0))),q(-7)),vRepeatE(eAutoref(4),pAutoref(0))),sAddS(s(vPerpetuumMobileLoop(nAutoref(2),lmAutoref(0),laLine(aRnd(),aRnd(),z(9)),liAutoref(3))),sAutoref(3)))))", "s(v(e(p(0),p(0),p(0),p(0))))" ],
							"notevalueF" : [ "nRnd()", "n(0.026874)", "nAutoref(0)", "nAutoref(2)", "n(0.420541)", "n(0.006717)", "nAutoref(5)", "n(0.363098)", "n(0.139219)" ],
							"lnotevalueF" : [ "ln(0.363098,0.106656,0.85244,0.035321)", "lnRemap(ln(0.363098,0.106656,0.85244,0.035321),n(0.006717),nAutoref(5))", "ln(0.026874,0.084359,0.068707,0.192584,0.113254,0.114948,0.023837,0.182483,0.426484)", "lnRemap(ln(0.026874,0.084359,0.068707,0.192584,0.113254,0.114948,0.023837,0.182483,0.426484),n(0.139219),nRnd())" ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [ "m(43)", "mAutoref(0)", "mRnd()", "m(53)", "mAutoref(2)", "mAutoref(4)", "m(40)", "mAutoref(1)", "m(56)" ],
							"lmidipitchF" : [ "lm(43)", "lmLine(mRnd(),m(56),z(38))", "lmAutoref(0)", "lmLine(mRnd(),m(56),z(41))", "lmAutoref(1)", "lm(68,85,65,91,81,56)" ],
							"frequencyF" : [  ],
							"lfrequencyF" : [  ],
							"articulationF" : [ "a(25)", "aRnd()", "aAutoref(0)" ],
							"larticulationF" : [ "laLine(aRnd(),aRnd(),z(24))", "laLine(aRnd(),aRnd(),z(27))", "laAutoref(0)", "laAutoref(2)", "laLine(aRnd(),aRnd(),z(23))", "laRemap(laLine(aRnd(),aRnd(),z(23)),aRnd(),aRnd())", "laLine(aRnd(),aRnd(),z(9))" ],
							"intensityF" : [ "i(0)", "iRnd()", "i(45)", "i(72)", "iAutoref(2)" ],
							"lintensityF" : [ "liLine(iRnd(),iRnd(),z(19))", "liRemap(liLine(iRnd(),iRnd(),z(19)),iRnd(),i(45))", "li(52,72,67,40,35)", "liRemap(li(52,72,67,40,35),iRnd(),iAutoref(2))", "li(85,54,77,50,53,60)", "liLine(iRnd(),iRnd(),z(22))", "liRemap(liLine(iRnd(),iRnd(),z(22)),iRnd(),i(45))", "liAutoref(1)", "liLine(iRnd(),iRnd(),z(16))", "liAutoref(3)" ],
							"goldenintegerF" : [ "z(252552)", "zRnd()", "z(420544)", "z(24)", "z(38)", "z(19)", "z(242963)", "z(13220)" ],
							"lgoldenintegerF" : [  ],
							"quantizedF" : [ "q(-7)" ],
							"lquantizedF" : [  ],
							"operationF" : [  ]
...
,
						"leaves" : [ [ 9, 0, 0 ], [ 14, 0, 0 ], [ 19, 0, 0 ], [ 24, 0, 0 ] ],
						"roll" : [ "(", "(", 0, ")", ")" ]
					}
,
					"fontname" : "Lato Regular",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.500008106231689, 686.516673028469086, 1082.0, 119.166666666666671 ],
					"pitcheditrange" : [ "null" ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 517.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ -0.5, -2.0, 618.0, 18.0 ],
									"text" : "0.618034 0.618034 0 0.618034 0 0 0"
								}
