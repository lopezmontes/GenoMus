...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20201221124605420_jlm",
...
,
						"initialConditions" : 						{
							...
							"genotypeSeed" : "2198606839567760",
							"phenotypeSeed" : "72992473574132"
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.867258, 1, 0.185365, 1, 0.590537, 0, 1, 0.826604, 0, 1, 0.826604, 0, 1, 0.826604, 0, 1, 0.062672, 0, 1, 0.680706, 0, 0, 1, 0.962453, 0, 0, 0 ],
						"decodedGenotype" : "s(vIterE(e3Pitches(nRnd(),mRnd(),mRnd(),mRnd(),aRnd(),iRnd()),pRnd()))",
						"formattedGenotype" : "s(\n   vIterE(\n      e3Pitches(\n         nRnd(),\n         mRnd(),\n         mRnd(),\n         mRnd(),\n         aRnd(),\n         iRnd()),\n      pRnd()))",
						"encodedPhenotype" : [ 0.618034, 0.236068, 0.222333758763419, 0.854102, 0.685998826492946, 0.558957845784199, 0.711985786300162, 0.616701058611935, 0.40570655159938, 0.464292813896981, 0.854102, 0.802084826791798, 0.556024692307639, 0.404862221772036, 0.536786985440083, 0.346156170295366 ],
						"subexpressions" : 						{
							"paramF" : [ "pRnd()" ],
							"listF" : [  ],
							"eventF" : [ "e3Pitches(nRnd(),mRnd(),mRnd(),mRnd(),aRnd(),iRnd())" ],
							"voiceF" : [ "vIterE(e3Pitches(nRnd(),mRnd(),mRnd(),mRnd(),aRnd(),iRnd()),pRnd())" ],
							"scoreF" : [ "s(vIterE(e3Pitches(nRnd(),mRnd(),mRnd(),mRnd(),aRnd(),iRnd()),pRnd()))" ],
							"notevalueF" : [ "nRnd()" ],
							"lnotevalueF" : [  ],
							"durationF" : [  ],
							"ldurationF" : [  ],
...
,
						"leaves" : [  ],
						"roll" : [ "(", "(", 0, "(", 8100, 58.371200000000002, 68, ")", "(", 6800, 58.371200000000002, 68, ")", "(", 8300, 58.371200000000002, 68, ")", ")", "(", 72.963999999999999, "(", 9200, 214.704599999999999, 62, ")", "(", 6800, 214.704599999999999, 62, ")", "(", 5200, 214.704599999999999, 62, ")", ")", ")" ]
					}
,
					"fontname" : "Lato Regular",
					"id" : "obj-111",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 517.0, 27.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ -0.5, -2.0, 618.0, 27.0 ],
									"text" : "0.618034 0.236068 0.222334 0.854102 0.685999 0.558958 0.711986 0.616701 0.405707 0.464293 0.854102 0.802085 0.556025 0.404862 0.536787 0.346156"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 0.0, 2.5, 902.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, -0.5, 902.0, 18.0 ],
									"text" : "roll ( ( 0 ( 8100 58.3712 68 ) ( 6800 58.3712 68 ) ( 8300 58.3712 68 ) ) ( 72.964 ( 9200 214.7046 62 ) ( 6800 214.7046 62 ) ( 5200 214.7046 62 ) ) )",
