...
## Definitions
- **genotype**: Set of connected functions representing compositional procedures.
- **phenotype**: Piece of music generated by a genotype.
- **encoded genotype**: Genotype coded as an array of normalized floats from interval [0, 1].
