...
Prolationes can be arbitrarily complex. A simple array like `[1,[2,3],1,[1,[1,4],4,2],1,[2,2,[3,4,4]]]` produce nested tuplets (total reference note value is a whole note):
