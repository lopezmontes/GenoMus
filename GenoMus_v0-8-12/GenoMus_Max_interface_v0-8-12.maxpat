...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20210426212417835_jlm",
							"GenoMusVersion" : "0.8.12",
							"milliseconsElapsed" : 23,
							"voices" : 1,
							"events" : 2,
							"encGenotypeLength" : 53,
							"decGenotypeLength" : 148,
							"depth" : 5
						}
,
						"initialConditions" : 						{
							...
							"germinalVector" : [ 0.208318, 0.168628, 0.815209, 0.714994, 0.600464, 0.250316, 0.132291, 0.410866, 0.687353, 0.734863, 0.079917, 0.051413, 0.906563, 0.258402, 0.01432, 0.039037, 0.697638, 0.101477, 0.63885, 0.474611, 0.103017, 0.621247, 0.872193, 0.933456, 0.134448, 0.974341, 0.22692 ],
							"germinalVectorLength" : 27,
							"germinalVectorDeviation" : 134.694277682554542,
							"genotypeSeed" : "16913648393360",
							"phenotypeSeed" : "96600537605153"
						}
,
						"encodedGenotype" : [ 1, 0.193496, 1, 0.472136, 1, 0.854102, 1, 0.236068, 1, 0, 0.5, 0, 0, 1, 0.326238, 0.53, 0.31, 0, 1, 0, 0.5, 0, 0, 1, 0, 0.5, 0, 0, 0, 0, 0, 1, 0.472136, 1, 0.224832, 1, 0.09017, 0.51, 0, 0, 1, 0.506578, 0.53, 0.47, 0.53, 0.62, 0.53, 0.93, 0, 1, 0.742646, 0.55, 0, 0, 1, 0.736435, 1, 0.36068, 0.56, 0.69, 0.56, 0.08, 0, 1, 0.18034, 0.56, 0, 0, 1, 0.285585, 0.57, 0, 0, 0, 0, 0, 0 ],
						"decodedGenotype" : "sConcatS(s(v(e(p(0),m(43),p(0),p(0)))),s(vPerpetuumMobile(n(0.000001),lm(59,74,105),la(0),liRemap(li(69,8),i(0),iAutoref(0)))))",
						"formattedGenotype" : "sConcatS(\n   s(\n      v(\n         e(\n            p(0),\n            m(43),\n            p(0),\n            p(0)))),\n   s(\n      vPerpetuumMobile(\n         n(0.000001),\n         lm(\n            59,\n            74,\n            105),\n         la(\n            0),\n         liRemap(\n            li(\n               69,\n               8),\n            i(0),\n            iAutoref(0)))))",
						"encodedPhenotype" : [ 0.618034, 0.236068, 0, 0.618034, 0.31, 0, 0, 0, 0.618034, 0.47, 0, 0 ],
						"subexpressions" : 						{
							"paramF" : [ "p(0)" ],
							"listF" : [  ],
							"eventF" : [ "e(p(0),m(43),p(0),p(0))" ],
							"voiceF" : [ "v(e(p(0),m(43),p(0),p(0)))", "vPerpetuumMobile(n(0.000001),lm(59,74,105),la(0),liRemap(li(69,8),i(0),iAutoref(0)))" ],
							"scoreF" : [ "s(v(e(p(0),m(43),p(0),p(0))))", "s(vPerpetuumMobile(n(0.000001),lm(59,74,105),la(0),liRemap(li(69,8),i(0),iAutoref(0))))", "sConcatS(s(v(e(p(0),m(43),p(0),p(0)))),s(vPerpetuumMobile(n(0.000001),lm(59,74,105),la(0),liRemap(li(69,8),i(0),iAutoref(0)))))" ],
							"notevalueF" : [ "n(0.000001)" ],
							"lnotevalueF" : [  ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [ "m(43)" ],
							"lmidipitchF" : [ "lm(59,74,105)" ],
							"frequencyF" : [  ],
							"lfrequencyF" : [  ],
							"articulationF" : [  ],
							"larticulationF" : [ "la(0)" ],
							"intensityF" : [ "i(0)", "iAutoref(0)" ],
							"lintensityF" : [ "li(69,8)", "liRemap(li(69,8),i(0),iAutoref(0))" ],
							"goldenintegerF" : [  ],
							"lgoldenintegerF" : [  ],
							"quantizedF" : [  ],
							"lquantizedF" : [  ],
...
,
						"leaves" : [ [ 11, 0, 0 ], [ 16, 0.31, 43 ], [ 21, 0, 0 ], [ 26, 0, 0 ], [ 38, 0, 0.003906 ], [ 43, 0.47, 59 ], [ 45, 0.62, 74 ], [ 47, 0.93, 105 ], [ 52, 0, 0 ], [ 59, 0.69, 69 ], [ 61, 0.08, 8 ], [ 66, 0, 0 ] ],
...
, 							{
								"box" : 								{
									...
									"text" : "0.618034 0.236068 0 0.618034 0.31 0 0 0 0.618034 0.47 0 0"
								}
