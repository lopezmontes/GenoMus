...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20210428131048202_jlm",
							"GenoMusVersion" : "0.8.12",
							"species" : "piano",
							"iterations" : 0,
							"milliseconsElapsed" : 1,
							"depth" : 4,
							"voices" : 1,
							"events" : 1,
							"decGenotypeLength" : 38,
							"encGenotypeLength" : 27,
							"germinalVectorLength" : 27,
							"germinalVectorDeviation" : 0,
							"genotypeSeed" : "23418889459570"
						}
,
						"initialConditions" : 						{
							"germinalVector" : [ 1, 0.472136, 1, 0.854102, 1, 0.236068, 1, 0.09017, 0.51, 0, 0, 1, 0.326238, 0.53, 0.31, 0, 1, 0.062672, 0, 1, 0.18034, 0.56, 0, 0, 0, 0, 0 ],
							...
							"phenotypeSeed" : 244598888196442
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.854102, 1, 0.236068, 1, 0.09017, 0.51, 0, 0, 1, 0.326238, 0.53, 0.31, 0, 1, 0.062672, 0, 1, 0.18034, 0.56, 0, 0, 0, 0, 0 ],
						"decodedGenotype" : "s(v(e(n(0.003906),m(43),aRnd(),i(0))))",
						"formattedGenotype" : "s(\n   v(\n      e(\n         n(0.003906),\n         m(43),\n         aRnd(),\n         i(0))))",
						"encodedPhenotype" : [ 0.618034, 0.618034, 0, 0.618034, 0.31, 0.481588, 0 ],
						"subexpressions" : 						{
							"paramF" : [  ],
							"listF" : [  ],
							"eventF" : [ "e(n(0.003906),m(43),aRnd(),i(0))" ],
							"voiceF" : [ "v(e(n(0.003906),m(43),aRnd(),i(0)))" ],
							"scoreF" : [ "s(v(e(n(0.003906),m(43),aRnd(),i(0))))" ],
							"notevalueF" : [ "n(0.003906)" ],
							"lnotevalueF" : [  ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [ "m(43)" ],
...
,
						"leaves" : [ [ 9, 0, 0.003906 ], [ 14, 0.31, 43 ], [ 22, 0, 0 ] ],
						"roll" : [ "(", "(", 0, ")", ")" ]
					}
,
					"fontname" : "Lato Regular",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 1809.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ -210.5, 5.0, 348.0, 18.0 ],
									"text" : "0.618034 0.618034 0 0.618034 0.31 0.481588 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 0.0, 2.5, 349.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, -0.5, 349.0, 18.0 ],
									"text" : "roll ( ( 0 ) )",
