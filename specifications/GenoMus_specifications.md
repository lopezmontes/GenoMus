...
### **articulationF** (a)
Conversion formulae: normalized parameter _**p**_ to relative articulation _**a**_, as a percentage of event duration ([graph](https://www.desmos.com/calculator/vue1f2arqw)):
