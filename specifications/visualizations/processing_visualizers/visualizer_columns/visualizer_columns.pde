...
float[] pheno = {1, 0.472136, 1, 0.304952, 1, 0.27051, 0.8, 0.51, 0.7, 0.51, 0.6, 0.2, 0, 1, 0.506578, 0.8, 0.53, 0.51, 0.53, 0.55, 0.53, 0.51, 0.53, 0.46, 0.2, 0, 1, 0.562306, 0.55, 0.667539, 0, 1, 0.18034, 0.56, 0,330709, 0, 0, 0};
...
void setup() {
 size(1000, 65);
 // size(300, 65, SVG, "genvisualization.svg");
 background(255);
 colorMode(HSB, 255, 200, 255);
 midX = width/2;
 midY = height/2;
 frameRate(10);
 allBranches();
...
//    fill(pheno[i]);
    ...
    if (pheno[i]==0 || pheno[i]==0.2 || pheno[i]==0.5 || pheno[i]==0.8 ||pheno[i]==1) {
      fill(0);
    } else {
      fill(((245-pheno[i]*245)*96%245), 255, 255);
    }
    ...
    rect(i*6,height,5,pheno[i]*(-60)-5,3);
