...
\setlength{\tabcolsep}{7pt} % Default value: 6pt
\renewcommand{\arraystretch}{1.8} % Default value: 1
\begin{tabular}{p{2.2cm} p{4cm} p{1.8cm} p{6cm}}
\toprule
...
Our framework have been implemented using JavaScript for the core code, and Max\footnote{\url{https://www.cycling74.com}} and the bach\footnote{\url{https://www.bachproject.net}} package for realtime interaction with the results of the generative processes. 


\subsection{Decoded genotype: a procedural function tree of the piece}
\begin{lstlisting}[float,floatplacement=H, language=Java, caption={Decoded genotype of \emph{Clapping Music} model.}\label{lst:clap-geno}]
