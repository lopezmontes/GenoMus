...
%    pdftitle={\emph{Título del documento en el PDF},    % title
%    pdfauthor={Nombre de autor/a},     % author
%    pdfsubject={Tema del documento},   % subject of the document
%    pdfcreator={Creator},   % creator of the document
%    % pdfproducer={Producer}, % producer of the document
%    pdfkeywords={palabra clave 1} {palabra clave 2}, % list of keywords
...
\subsection{Overview of the model and complementary materials}
...
Detalle del uso de golden angle para codificar enteros.
Aplicaciones:
- Espaciado equilibrado de punteros a funciones en el rango 0-1
- Codificación de enteros en fenotipos (número de voces, de notas, etc.)
...
\subsection{Extraction of new functions from music}
