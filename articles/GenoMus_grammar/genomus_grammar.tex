...
Our model derivates the whole composition as transformations of the first four notes (motif $A$), appling five generic operations using the genotype functions explained in Table~\ref{table:funcs}.
