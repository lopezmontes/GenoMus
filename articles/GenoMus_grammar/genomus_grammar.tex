...
Although its target is not only genetic algorithms, the \textsl{GenoMus} framework uses the evolutionary metaphor, as many other automatic composition systems \cite{Sulyok2019, SnchezQuintana2013}. Each system has its particular definition of evolutionary terms, sometimes denoting even opposite 
