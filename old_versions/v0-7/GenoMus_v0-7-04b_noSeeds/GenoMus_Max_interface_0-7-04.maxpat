...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 359.0, 262.0 ],
									"presentation" : 1,
									"presentation_linecount" : 28,
									"presentation_rect" : [ -0.5, -2.0, 359.0, 262.0 ],
...
, 			{
				...
				"bootpath" : "~/Dropbox/tesis/GenoMus/GenoMus_v0-7-04b_oldRandom",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
