...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"iterations" : 1,
							"milliseconsElapsed" : 35,
							"voices" : 1,
							"events" : 5
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.845971, 1, 0.867258, 1, 0.567331, 1, 0.09017, 0.51, 0, 0, 1, 0.326238, 0.53, 0.31, 0, 1, 0.431483, 0.57, 0, 0, 1, 0.562306, 0.55, 0.641623, 0, 1, 0.18034, 0.56, 0, 0, 0, 1, 0, 0.5, 0.5, 0, 0, 1, 0.854102, 1, 0.185365, 1, 0.195415, 0.57, 0, 0, 1, 0.431483, 0.57, 0, 0, 1, 0.326238, 0.53, 0.290816, 0, 1, 0.326238, 0.53, 0.339236, 0, 1, 0.562306, 0.55, 0.351264, 0, 1, 0.285585, 0.57, 0, 0, 0, 0, 0, 0 ],
						"decodedGenotype" : "s(vABAv(vIterE(e2Pitches(n(0.000001),m(43),mAutoref(0),a(0.897953),i(0)),p(0.5)),v(e3Pitches(nAutoref(0),mAutoref(0),m(41.0816),m(45.9236),a(0.174592),iAutoref(0)))))",
						"formattedGenotype" : "s(\n  vABAv(\n    vIterE(\n      e2Pitches(\n        n(0.000001),\n        m(43),\n        mAutoref(0),\n        a(0.897953),\n        i(0)),\n      p(0.5)),\n    v(\n      e3Pitches(\n        nAutoref(0),\n        mAutoref(0),\n        m(41.0816),\n        m(45.9236),\n        a(0.174592),\n        iAutoref(0)))))",
						"encodedPhenotype" : [ 0.618034, 0.09017, 0, 0.236068, 0.31, 0.31, 0.641623, 0, 0, 0.236068, 0.31, 0.31, 0.641623, 0, 0, 0.854102, 0.31, 0.290816, 0.339236, 0.351264, 0, 0, 0.236068, 0.31, 0.31, 0.641623, 0, 0, 0.236068, 0.31, 0.31, 0.641623, 0 ],
						"subexpressions" : 						{
							"paramF" : [ "p(0.5)" ],
							"listF" : [  ],
							"eventF" : [ "e2Pitches(n(0.000001),m(43),mAutoref(0),a(0.897953),i(0))", "e3Pitches(nAutoref(0),mAutoref(0),m(41.0816),m(45.9236),a(0.174592),iAutoref(0))" ],
							"voiceF" : [ "vIterE(e2Pitches(n(0.000001),m(43),mAutoref(0),a(0.897953),i(0)),p(0.5))", "v(e3Pitches(nAutoref(0),mAutoref(0),m(41.0816),m(45.9236),a(0.174592),iAutoref(0)))", "vABAv(vIterE(e2Pitches(n(0.000001),m(43),mAutoref(0),a(0.897953),i(0)),p(0.5)),v(e3Pitches(nAutoref(0),mAutoref(0),m(41.0816),m(45.9236),a(0.174592),iAutoref(0))))" ],
							"scoreF" : [ "s(vABAv(vIterE(e2Pitches(n(0.000001),m(43),mAutoref(0),a(0.897953),i(0)),p(0.5)),v(e3Pitches(nAutoref(0),mAutoref(0),m(41.0816),m(45.9236),a(0.174592),iAutoref(0)))))" ],
							"notevalueF" : [ "n(0.000001)", "nAutoref(0)" ],
							"lnotevalueF" : [  ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [ "m(43)", "mAutoref(0)", "m(41.0816)", "m(45.9236)" ],
							"lmidipitchF" : [  ],
							"frequencyF" : [  ],
							"lfrequencyF" : [  ],
							"articulationF" : [ "a(0.897953)", "a(0.174592)" ],
							"larticulationF" : [  ],
							"intensityF" : [ "i(0)", "iAutoref(0)" ],
							"lintensityF" : [  ],
							"goldenintegerF" : [  ],
							"lgoldenintegerF" : [  ],
							"quantizedF" : [  ],
...
,
						"roll" : [ "(", "(", 0, "(", 4300, 14.029617672000001, 0, ")", "(", 4300, 14.029617672000001, 0, ")", ")", "(", 15.624000000000001, "(", 4300, 14.029617672000001, 0, ")", "(", 4300, 14.029617672000001, 0, ")", ")", "(", 31.248000000000001, "(", 4300, 2.727825408, 0, ")", "(", 4108.159999999999854, 2.727825408, 0, ")", "(", 4592.359999999999673, 2.727825408, 0, ")", ")", "(", 46.872, "(", 4300, 14.029617672000001, 0, ")", "(", 4300, 14.029617672000001, 0, ")", ")", "(", 62.496000000000002, "(", 4300, 14.029617672000001, 0, ")", "(", 4300, 14.029617672000001, 0, ")", ")", ")" ]
					}
,
					"id" : "obj-111",
					"maxclass" : "newobj",
...
, 			{
				"box" : 				{
					...
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 0.0, 17.0 ],
					"whole_roll_data_0000000000" : [ "roll", "(", "slotinfo", "(", 1, "(", "name", "amplitude envelope", ")", "(", "type", "function", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1080016896, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "ysnap", "(", ")", ")", "(", "domain", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, ")", "(", "domainslope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "width", "temporal", ")", "(", "height", "auto", ")", ")", "(", 2, "(", "name", "slot function", ")", "(", "type", "function", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "ysnap", "(", ")", ")", "(", "domain", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, ")", "(", "domainslope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "width", "temporal", ")", "(", "height", "auto", ")", ")", "(", 3, "(", "name", "slot intlist", ")", "(", "type", "intlist", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1080016896, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "default", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1078984704, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 4, "(", "name", "slot floatlist", ")", "(", "type", "floatlist", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "default", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 5, "(", "name", "slot int", ")", "(", "type", "int", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1080016896, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "default", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1078984704, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 6, "(", "name", "slot float", ")", "(", "type", "float", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1072693248, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "default", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 7, "(", "name", "lyrics", ")", "(", "type", "text", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 8, "(", "name", "filelist", ")", "(", "type", "filelist", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1080213504, ")", "(", "height", "auto", ")", ")", "(", 9, "(", "name", "spat", ")", "(", "type", "spat", ")", "(", "key", 0, ")", "(", "range", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1076101120, ")", "(", "slope", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, ")", "(", "representation", ")", "(", "width", "temporal", ")", "(", "height", "auto", ")", ")", "(", 10, "(", "name", "slot 10", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 11, "(", "name", "slot 11", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 12, "(", "name", "slot 12", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 13, "(", "name", "slot 13", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 14, "(", "name", "slot 14", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 15, "(", "name", "slot 15", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 16, "(", "name", "slot 16", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 17, "(", "name", "slot 17", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 18, "(", "name", "slot 18", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 19, "(", "name", "slot 19", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 20, "(", "name", "slot 20", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 21, "(", "name", "slot 21", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 22, "(", "name", "slot 22", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 23, "(", "name", "slot 23", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 24, "(", "name", "slot 24", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 25, "(", "name", "slot 25", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 26, "(", "name", "slot 26", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 27, "(", "name", "slot 27", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 28, "(", "name", "slot 28", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 29, "(", "name", "slot 29", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", "(", 30, "(", "name", "slot 30", ")", "(", "type", "none", ")", "(", "key", 0, ")", "(", "width", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1079574528, ")", "(", "height", "auto", ")", ")", ")", "(", "commands", "(", 1, "(", "note", "note", ")", "(", "chord", "chord", ")", "(", "rest", "rest", ")", "(", "key", 0, ")", ")", "(", 2, "(", "note", "note", ")", "(", "chord", "chord", ")", "(", "rest", "rest", ")", "(", "key", 0, ")", ")", "(", 3, "(", "note", "note", ")", "(", "chord", "chord", ")", "(", "rest", "rest", ")", "(", "key", 0, ")", ")", "(", 4, "(", "note", "note", ")", "(", "chord", "chord", ")", "(", "rest", "rest", ")", "(", "key", 0, ")", ")", "(", 5, "(", "note", "note", ")", "(", "chord", "chord", ")", "(", "rest", "rest", ")", "(", "key", 0, ")", ")", ")", "(", "groups", ")", "(", "markers", ")", "(", "midichannels", 1, ")", "(", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 0, "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 26739, 1076838268, "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 26739, 1077886844, "(", "_x_x_x_x_bach_float64_x_x_x_x_", 36700, 1085279272, "_x_x_x_x_bach_float64_x_x_x_x_", 30334, 1074123414, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 30334, 1074123414, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 49807, 1085403228, "_x_x_x_x_bach_float64_x_x_x_x_", 30334, 1074123414, 1, 0, ")", 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 3670, 1078423453, "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 26739, 1078935420, "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", "(", "_x_x_x_x_bach_float64_x_x_x_x_", 0, 1085328384, "_x_x_x_x_bach_float64_x_x_x_x_", 16208, 1076629290, 1, 0, ")", 0, ")", 0, ")" ],
					"whole_roll_data_count" : [ 1 ],
					"zoom" : 54.0
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 0.833334445953369, 2.750006437301636, 843.0, 1774.0 ],
									"presentation" : 1,
									"presentation_linecount" : 18,
									"presentation_rect" : [ 0.833334445953369, 26.750006437301636, 889.0, 3563.450018703937531 ],
									"text" : "\"s(\n  vABAv(\n    vIterE(\n      e2Pitches(\n        n(0.000001),\n        m(43),\n        mAutoref(0),\n        a(0.897953),\n        i(0)),\n      p(0.5)),\n    v(\n      e3Pitches(\n        nAutoref(0),\n        mAutoref(0),\n        m(41.0816),\n        m(45.9236),\n        a(0.174592),\n        iAutoref(0)))))\"",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -0.5, -2.0, 441.0, 36.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ -0.5, -2.0, 575.0, 27.0 ],
									"text" : "0.618034 0.09017 0 0.236068 0.31 0.31 0.641623 0 0 0.236068 0.31 0.31 0.641623 0 0 0.854102 0.31 0.290816 0.339236 0.351264 0 0 0.236068 0.31 0.31 0.641623 0 0 0.236068 0.31 0.31 0.641623 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 0.0, 2.5, 810.0, 27.0 ],
									"presentation" : 1,
									"presentation_linecount" : 2,
									"presentation_rect" : [ 0.0, -0.5, 810.0, 27.0 ],
									"text" : "roll ( ( 0 ( 4300 14.029618 0 ) ( 4300 14.029618 0 ) ) ( 15.624 ( 4300 14.029618 0 ) ( 4300 14.029618 0 ) ) ( 31.248 ( 4300 2.727825 0 ) ( 4108.16 2.727825 0 ) ( 4592.36 2.727825 0 ) ) ( 46.872 ( 4300 14.029618 0 ) ( 4300 14.029618 0 ) ) ( 62.496 ( 4300 14.029618 0 ) ( 4300 14.029618 0 ) ) )",
