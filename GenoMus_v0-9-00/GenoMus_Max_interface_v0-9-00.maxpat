...
, 			{
				"box" : 				{
					"data" : 					{
						"metadata" : 						{
							"specimenID" : "20210508113643820_jlm",
							...
							"voices" : 1,
							"events" : 2,
							"decGenotypeLength" : 105,
							"encGenotypeLength" : 48,
							"germinalVectorLength" : 48,
							"germinalVectorDeviation" : 0
						}
,
						"initialConditions" : 						{
							"germinalVector" : [ 1, 0.472136, 1, 0.842866, 1, 0.590537, 0, 1, 0.882333, 1, 0.38891, 1, 0.172209, 1, 0, 0.5, 0.58906, 0, 1, 0, 0.5, 0.390926, 0, 0, 0, 1, 0.826604, 0, 1, 0.326238, 0.53, 0.5, 0, 0, 1, 0.742646, 0.55, 0.168213, 0, 1, 0.36068, 0.56, 0.029312, 0.56, 1, 0, 0, 0 ],
							...
							"phenotypeSeed" : 114747076542480
						}
,
						"encodedGenotype" : [ 1, 0.472136, 1, 0.842866, 1, 0.590537, 0, 1, 0.882333, 1, 0.38891, 1, 0.172209, 1, 0, 0.5, 0.58906, 0, 1, 0, 0.5, 0.390926, 0, 0, 0, 1, 0.826604, 0, 1, 0.326238, 0.53, 0.5, 0, 0, 1, 0.742646, 0.55, 0.168213, 0, 1, 0.36068, 0.56, 0.029312, 0.56, 1, 0, 0, 0 ],
						"decodedGenotype" : "s(vPerpetuumMobileLoop(nRnd(),lmRemap(lP2M(l2P(p(0.58906),p(0.390926))),mRnd(),m(62)),la(16),li(15,100)))",
						"formattedGenotype" : "s(\n   vPerpetuumMobileLoop(\n      nRnd(),\n      lmRemap(\n         lP2M(\n            l2P(\n               p(0.58906),\n               p(0.390926))),\n         mRnd(),\n         m(62)),\n      la(\n         16),\n      li(\n         15,\n         100)))",
						"encodedPhenotype" : [ 0.618034, 0.236068, 0.342082, 0.618034, 0.5, 0.168213, 0.029312, 0.342082, 0.618034, 0.650018, 0.168213, 1 ],
						"subexpressions" : 						{
							"paramF" : [ "p(0.58906)", "p(0.390926)" ],
							"listF" : [ "l2P(p(0.58906),p(0.390926))" ],
							"eventF" : [  ],
							"voiceF" : [ "vPerpetuumMobileLoop(nRnd(),lmRemap(lP2M(l2P(p(0.58906),p(0.390926))),mRnd(),m(62)),la(16),li(15,100))" ],
							"scoreF" : [ "s(vPerpetuumMobileLoop(nRnd(),lmRemap(lP2M(l2P(p(0.58906),p(0.390926))),mRnd(),m(62)),la(16),li(15,100)))" ],
							"notevalueF" : [ "nRnd()" ],
							"lnotevalueF" : [  ],
							"durationF" : [  ],
							"ldurationF" : [  ],
							"midipitchF" : [ "mRnd()", "m(62)" ],
							"lmidipitchF" : [ "lP2M(l2P(p(0.58906),p(0.390926)))", "lmRemap(lP2M(l2P(p(0.58906),p(0.390926))),mRnd(),m(62))" ],
							"frequencyF" : [  ],
							"lfrequencyF" : [  ],
							"articulationF" : [  ],
							"larticulationF" : [ "la(16)" ],
							"intensityF" : [  ],
							"lintensityF" : [ "li(15,100)" ],
							"goldenintegerF" : [  ],
							"lgoldenintegerF" : [  ],
							"quantizedF" : [  ],
							"lquantizedF" : [  ],
...
,
						"leaves" : [ [ 16, 0.58906, 0.58906 ], [ 21, 0.390926, 0.390926 ], [ 31, 0.5, 62 ], [ 37, 0.168213, 16 ], [ 42, 0.029312, 15 ], [ 44, 1, 100 ] ],
						"roll" : [ "(", "(", 0, "(", 6200, 50.840319999999991, 42, ")", ")", "(", 317.751999999999953, "(", 6800, 50.840319999999991, 127, ")", ")", ")" ]
					}
,
					"fontname" : "Lato Regular",
					"id" : "obj-111",
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ -210.5, 5.0, 364.0, 27.0 ],
									"text" : "0.618034 0.236068 0.342082 0.618034 0.5 0.168213 0.029312 0.342082 0.618034 0.650018 0.168213 1"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "roll ( ( 0 ( 6200 50.84032 42 ) ) ( 317.752 ( 6800 50.84032 127 ) ) )",
